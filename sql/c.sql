...
CREATE TABLE public.payroll_records (
  ...
  CONSTRAINT payroll_records_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id),
  CONSTRAINT payroll_records_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id)
);
